...
const isAdmin = () => {
  ...
  return (
    user &&
    (user.designation === "Reporting Head" ||
      user.designation === "Sanctioning Authority")
  );
};
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            path="/AdminApproval"
            element={<AdminRoute element={<AdminLeaveRequests />} />}
          />
          <Route
          ...
          <Route
            path="/admin/logout"
            element={<AdminRoute element={<AdminLogout />} />}
          />
          ...
          <Route
            path="/updateEmployee"
            element={<UserRoute element={<UpdateEmployee />} />}
          />
          <Route
            path="/emp-salary"
            element={<UserRoute element={<Payslip />} />}
          />
          <Route
            path="/add-salary"
            element={<UserRoute element={<AddSalaryForm />} />}
          />
          <Route
            path="/empMaster"
            element={<UserRoute element={<EmployeeManager />} />}
          />
          <Route
            path="/emplist"
            element={<UserRoute element={<EmployeeList />} />}
          />
          <Route
            path="/save-salaries"
            element={<UserRoute element={<SaveSalaries />} />}
          />
          <Route
            path="/EmpLeaveStatus"
            element={<UserRoute element={<ApprovedLeaveList />} />}
          />
          <Route
            path="/addbank"
            element={<UserRoute element={<AddBankForm />} />}
          />
          <Route
            path="/bankdetails"
            element={<UserRoute element={<BankDetails />} />}
          />
          <Route
            path="/AddHoliday"
            element={<UserRoute element={<AddHoliday />} />}
          />
